...
const Footer = () => {
    return (
        <div id='Footer' className='flex flex-col lg:flex-row justify-between text-white py-28 md:py-28 p-6 md:p-16 gap-8 lg:gap-0'>
            <img className='w-40 md:w-50' src="https://qdioerqypevvqctowrbv.supabase.co/storage/v1/object/public/picton//Logo.svg" alt="" />

            <div className='flex flex-col lg:w-[40%] gap-6 md:gap-4 mt-6 md:mt-0'>
